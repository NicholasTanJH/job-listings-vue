                ...
                <form @submit.prevent="handleUpdate">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.title" type="text" id="name" name="name"
                            class="border rounded-sm w-full py-2 px-3 mb-2"
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.salary" id="salary" name="salary"
                            class="border rounded-sm w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.location" type="text" id="location" name="location"
                            class="border rounded-sm w-full py-2 px-3 mb-2" placeholder="Company Location" required />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.name" type="text" id="company" name="company"
                            class="border rounded-sm w-full py-2 px-3" placeholder="Company Name" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactEmail" type="email" id="contact_email" name="contact_email"
                            class="border rounded-sm w-full py-2 px-3" placeholder="Email address for applicants"
                            required />
                    </div>
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactPhone" type="tel" id="contact_phone" name="contact_phone"
                            class="border rounded-sm w-full py-2 px-3" placeholder="Optional phone for applicants" />
                    </div>
